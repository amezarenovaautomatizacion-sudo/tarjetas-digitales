          ...
          <div style={{
            ...
            {qrLoading ? (
              <div style={{ textAlign: 'center' }}>
                ...
                <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem' }}>Generando código QR...</p>
              </div>
            ) : qrError ? (
              <div style={{ padding: '1rem', textAlign: 'center' }}>
                <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem' }}>{qrError}</p>
              </div>
            ) : qrImageUrl ? (
              <img 
                src={qrImageUrl} 
