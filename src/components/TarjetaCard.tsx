// src/components/TarjetaCard.tsx
...
const TarjetaCard: React.FC<TarjetaCardProps> = ({ 
  tarjeta, onClick, onPublicClick, onDelete, onToggleVisibility 
}) => {
  const formatDate = (date: string) => new Date(date).toLocaleDateString('es-MX');

  return (
    <div className="tarjeta-card">
      <div className="tarjeta-card-header" onClick={onClick}>
      ...
      <div className="tarjeta-card-body" onClick={onClick}>
